...
#autoNextMsg{position:fixed;top:35%;left:50%;transform:translate(-50%,-50%);-webkit-transform:translate(-50%,-50%);display:none;background:rgba(60,45,0,0.95);color:#ffcc00;border:2px solid #ffcc00;padding:14px 22px;border-radius:12px;font-weight:bold;font-size:3.5vh;text-align:center;z-index:59;max-width:90vw;box-sizing:border-box;box-shadow:0 4px 18px rgba(0,0,0,0.5)}
...
var VERSAO_PAGINA=19, checadoVersao=false;
